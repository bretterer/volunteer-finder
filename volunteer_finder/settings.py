"""
Django settings for volunteer_finder project.
...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-t)z56jv+75@k#3r^tm53*(6hu513u2_gp!915r4iz^9(*d67vd')
...
ROOT_URLCONF = 'volunteer_finder.urls'
...
WSGI_APPLICATION = 'volunteer_finder.wsgi.application'
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='Volunteer Finder <noreply@volunteerfinder.com>')
